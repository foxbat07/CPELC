     ...
     if (set1.leftHandY<          set1.skeletonY && set1.rightHandY<           set1.skeletonY)
         {
              ...
              { 
                ...
                text(" 2 hand mode", width, height -100);
              }
          checkRotate();
          checkRevolve();
          checkZoom();
     ...
     if (  ((set1.leftHandY<           set1.skeletonY)&& (set1.rightHandY>           set1.skeletonY)) || ((set1.leftHandY>           set1.skeletonY)&& (set1.rightHandY<           set1.skeletonY))   )
        { 
          onehandGUI(); 
              ...
              text(" 1 hand mode", width,height-100);
              }
    ...
    if (set1.leftHandY>          set1.skeletonY && set1.rightHandY>           set1.skeletonY)
         {
          
             {
              ...
              text(" hands down", width,height- 100);
    ...
    if(skeletonDetected)
        {
          ...
          text("Skeleton Detected", width-20,150);
        }
    if(handDetected)
        {
          
          text("Hand Detected", width-20,180);
        }
