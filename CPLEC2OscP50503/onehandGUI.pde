void onehandGUI()
      ...
      if( (set1.leftHandX*width ) > (width-locX-blockwidth) && (set1.lefttHandX*width ) < (width-locX)  &&  (set1.lefttHandY* height) > locY && (set1.leftHandY*height ) < (locY+ blockheight)  && set2.leftHandX*width-5 > (width-locX-blockwidth) )                
         {
