   ...
   */
      ...
      if(metadataFlag)
        ...
        if(frameCount%15==0) 
           { 
           fill(#63FF63);  
           rect(width-locX-blockwidth-5-blockwidth/10,locY-diff, blockwidth/10,blockheight);   
           }
        }
      ...
      if(structureFlag)
        ...
        if(frameCount%15==0) 
           { 
           fill(#FF6363);  
           rect(width-locX-blockwidth-5-blockwidth/10,locY, blockwidth/10,blockheight);   
           }
        }  
      locY+=diff;
      if(objectiveCFlag)
